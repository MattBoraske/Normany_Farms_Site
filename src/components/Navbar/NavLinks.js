...
const NavLinks = () => {
    return (
        <div className="flex items-center">
            ...
            <HashLink className="px-4 font-extrabold text-gray-500 hover:text-blue-900" smooth to="/#volunteer-and-events">
                Volunteer
            </HashLink>
            <HashLink className="px-4 font-extrabold text-gray-500 hover:text-blue-900" smooth to="/#volunteer-and-events">
                Upcoming Events
            ...
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="px-4 font-extrabold text-gray-500 hover:text-blue-900" aria-label="Facebook">
